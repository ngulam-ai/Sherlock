...
public class putAudUserToDataStoreTest {
	...
	static final JSONObject USER_1 = new JSONObject().put("uid", "uid1").put("cd107", "107");
	static final JSONObject USER_2 = new JSONObject().put("uid", "uid2").put("cd108", "108");
	static final JSONObject USER_3 = new JSONObject().put("cd107", "107").put("cd108", "108");
	static final JSONObject USER_4 = new JSONObject().put("cd107", "107").put("cd109", "109");
	static final JSONObject USER_5 = new JSONObject().put("uid", "uid3").put("cd107", "another").put("cd109", "109");
