...
@Getter
@Slf4j
public class PerfectAudienceClientBuilder {
	
	PerfectAudienceClient perfectAudienceClient = createClient(PerfectAudienceClient.class, "https://api.perfectaudience.com");
	@Getter
